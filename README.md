...
To make the co-occurence matrix more manageable, only articles mentioning 10 or fewer genes were considered for co-occurences. There are a handful of articles in gene2pubmed that mention several thousand genes – including these articles would drastically increase the number of edges in these networks!
